...
fn load_ore_assets(
    ...
    let mesh = sdf::bake(OreAssets::shape(), sdf::Bounds::new(0.75, 4));
    let collider = Collider::convex_hull(sdf::points(&mesh)).expect("ore mesh has no convex hull");
