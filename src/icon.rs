...
fn fill(left: f32, top: f32, width: f32, height: f32, round: f32, color: Color) -> impl Bundle {
    (
...
fn ring(left: f32, top: f32, size: f32, thickness: f32, round: f32, color: Color) -> impl Bundle {
    ...
    glyph(children![turned(
        (
            part(
                ...
                10.0,
                10.0,
                BorderRadius::new(px(1.5), px(9.0), px(9.0), px(9.0)),
            ),
            BackgroundColor(color),
        ),
        45.0,
    ...
    glyph(children![turned(
        (
            part(
                ...
                9.0,
                9.0,
                BorderRadius::new(px(1.2), px(8.0), px(8.0), px(8.0)),
            ),
            BackgroundColor(color),
        ),
        -45.0,
